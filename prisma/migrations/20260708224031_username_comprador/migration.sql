...
CREATE TABLE "new_Compra" (
    ...
    "usernameComprador" TEXT NOT NULL DEFAULT 'unknown_user',
...
INSERT INTO "new_Compra" ("cantidad", "createdAt", "id", "productoId", "total", "usuarioId") SELECT "cantidad", "createdAt", "id", "productoId", "total", "usuarioId" FROM "Compra";
DROP TABLE "Compra";
